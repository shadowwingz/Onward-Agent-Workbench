...
// Match the convention established by `test/create-nested-git-submodule-fixture.mjs`:
// fixtures live under `test/fixtures/<suite>/runtime/` so developers can inspect
// after a failed run, the next invocation wipes-and-recreates for a known-good
// state, and `test/fixtures/<suite>/.gitignore` keeps generated content out of
