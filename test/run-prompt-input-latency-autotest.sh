...
node "$ROOT_DIR/test/prepare-prompt-input-latency-fixture.mjs"

WORK_DIR="$ROOT_DIR/test/fixtures/prompt-input-latency/workdir"
USER_DATA_DIR="$ROOT_DIR/test/fixtures/prompt-input-latency/user-data"
case "$USER_DATA_DIR" in
  "$ROOT_DIR"/test/fixtures/prompt-input-latency/user-data)
    rm -rf "$USER_DATA_DIR"
