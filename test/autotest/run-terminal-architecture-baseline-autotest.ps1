...
$ResultDir = Join-Path $RootDir "test\autotest\results\terminal-architecture-baseline"
...
$prepareScript = Join-Path $RootDir "test\autotest\prepare-terminal-architecture-baseline-fixture.mjs"
$fixtureSummary = node $prepareScript | Out-String
Write-Host $fixtureSummary

$WorkDir = Join-Path $RootDir "test\autotest\fixtures\terminal-architecture-baseline\workdir"
$UserDataDir = Join-Path $RootDir "test\autotest\fixtures\terminal-architecture-baseline\user-data"
