...
function usage(exitCode) {
  ...
  stream.write(`Usage:
  node test/autotest/compare-performance-baseline.mjs --before <baseline.json> --after <candidate.json> [--suite <suite>] [--profile optimization|regression] [--report-only] [--json]
