...
LOG_FILE="${2:-/tmp/onward-prompt-input-longtail-autotest.log}"
RESULT_DIR="$ROOT_DIR/test/results/prompt-input-longtail"
mkdir -p "$RESULT_DIR"
...
node "$ROOT_DIR/test/prepare-prompt-input-longtail-fixture.mjs"

WORK_DIR="$ROOT_DIR/test/fixtures/prompt-input-longtail/workdir"
USER_DATA_DIR="$ROOT_DIR/test/fixtures/prompt-input-longtail/user-data"
case "$USER_DATA_DIR" in
  "$ROOT_DIR"/test/fixtures/prompt-input-longtail/user-data)
    rm -rf "$USER_DATA_DIR"
